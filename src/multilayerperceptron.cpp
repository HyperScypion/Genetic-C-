...
double Network::forward_prop(std::vector <double> data, std::string activ)
{
...
virtual void Network::train(double learning_rate, int epochs, std::vector <double> data, std::vector <double> labels, std::string activ)
{
    double result;
